...
///
/// ***************************************************************************
/// File last update : 2025-03-09T19:34:32.000+01:00
/// Signature : 5cecb9b16c5e9bdd1237591e266cac22ffdbdf5c
/// ***************************************************************************
/// </summary>
...
const
  ...
  /// </summary>
  CAboutGameURL = 'https://dad48.gamolf.fr/';
...
{$ENDIF}
  ...
  /// (without deployment)
  /// </summary>
  CDefaultBackgroundMusicPath = '..\..\..\_PRIVATE\musics\NicheEmpire\602-36-Royalty-Free-Music-Tracks-Graphics-PLR\';
  ...
  /// </remarks>
  CBackgroundMusicFileName = 'OnTheRun.mp3';
  ...
  /// (without deployment)
  /// </summary>
  CDefaultSoundEffectsPath = '..\..\..\_PRIVATE\sounds\TheGameCreators\SoundMatter\';
  ...
  /// </summary>
  CGameGUID = '{7CA14971-B411-45F4-8DCF-BCFE8A5E3A7A}';
...
{$SCOPEDENUMS ON}
  ...
  TSceneType = (None (* "None" must stay *) , Exit (* "Exit" must stay *) ,
    Home, Game, GameOverLost, Credits, Options, HallOfFame, Tests);
...
Const
  ...
  /// </remarks>
  CDefaultSceneOnStartup = TSceneType.Tests;
